...
void setRangeLimits(){
  ...
  int funAnalogValue = analogRead(lowerThresholdPin);
  ...
  funAnalogValue = analogRead(rangePin);
...
void updateTempo(){
  // Analog pin 0 controlls the tempo and is reported in BPM
  int funPinData = analogRead(tempoPin);
